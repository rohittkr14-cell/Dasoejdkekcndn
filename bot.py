...
# Password handling with urllib.parse (Special characters like @ are safely handled)
db_user = urllib.parse.quote_plus("Cricket_231")
db_pass = urllib.parse.quote_plus("Rohit1616@") # Yahan apna asli password daal dena

MONGO_URI = f"mongodb+srv://{db_user}:{db_pass}@cluster0.zolmdho.mongodb.net/?retryWrites=true&w=majority"

client = MongoClient(MONGO_URI)
db = client["telegram_tedddy_bot"]
...
if __name__ == "__main__":
  keep_alive()
  print("Bot is successfully running on Render with Colored Buttons...")
